...
cq <- do.call(rbind, list(read.csv("original/elections/cq_congress_district/congressdata_1944-1960.csv", stringsAsFactors = F, skip=2),
                          read.csv("original/elections/cq_congress_district/congressdata_1962-1980.csv", stringsAsFactors = F, skip=2),
                          read.csv("original/elections/cq_congress_district/congressdata_1982-2000.csv", stringsAsFactors = F, skip=2)))

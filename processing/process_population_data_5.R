...
pop1970 <- read.csv("original/population_data_socialexplorer/census1970/R13208694_SL4601.csv", stringsAsFactors = F)
...
pop1980 <- read.csv("original/population_data_socialexplorer/census1980/R13208700_SL11.csv", stringsAsFactors = F)
...
pop1990 <- read.csv("original/population_data_socialexplorer/census1990/R13208704_SL050.csv", stringsAsFactors = F)
...
pop2000 <- read.csv("original/population_data_socialexplorer/census2000/R13208705_SL050.csv", stringsAsFactors = F)
...
pop2010 <- read.csv("original/population_data_socialexplorer/census2010/R13208706_SL050.csv", stringsAsFactors = F)
...
write.csv(pop, "working/population_data_countylevel.csv", row.names = F)
